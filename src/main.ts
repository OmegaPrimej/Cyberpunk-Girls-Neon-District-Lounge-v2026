...
// import { loadGLTF } from './utils/loaders'; // uncomment if needed

// ================================================================
// 1. SCENE SETUP WITH VIDEO BACKGROUND
// ================================================================
const scene = new THREE.Scene();
// We'll set the background to a video later
...
video.src = '/videos/background_loop.mp4';  // ensure this file exists in public/videos/
video.loop = true;
video.muted = true;
video.autoplay = true;
...
// Try to autoplay – fallback on user interaction
video.play().catch(() => {
...
// Optionally, set min/mag filter for smooth scaling
...
// (Optional) If you want a fallback color while video loads:
// scene.background = new THREE.Color(0x0a0a1a);
// Then on video 'canplay', set background = videoTexture.
...
// Example neon sign (flat emissive plane)
...
npcManager.addNPC({
  ...
  portrait: 'generated_forecast/forecast_000.png',
...
// ================================================================
// 6. VIDEO SCENARIO SYSTEM (for transitions)
// ================================================================
